    ...
    //  authority: ['admin', 'user'],
      routes: [
        ...
        },
        {
          ...
          name: '镜像管理',
          icon: 'cloud-server',
          component: './ImageManage/ImageList',
        },
        {
          path: '/ContainerManage/ContainerList',
          name: '实验台管理',
          icon: 'cloud-server',
          component: './ContainerManage/ContainerList',
        },
        {
        ...
        },
        {
          ...
          name: 'Markdown',
          icon: 'cloud-server',
          component: './Markdown/MarkdownEdit',
        },
        {
          component: './404',
        },
